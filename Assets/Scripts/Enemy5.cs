...
{
    private float _eSpeed = 7.0f;
    private int _eHealth = 3;
    private SpriteRenderer _childSpriteRenderer;
    [SerializeField]
    private GameObject _debufPrefab;
    ...
    void Start()
    {
        ...
        InvokeRepeating("DropDebuff", 1f, 3f);
    }
    ...
    public void DropDebuff()
    {
        float distanceBelow = 0.5f;

        Vector3 newPosition = new Vector3(transform.position.x, transform.position.y - distanceBelow, transform.position.z);
